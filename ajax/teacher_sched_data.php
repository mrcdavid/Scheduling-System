                ...
                foreach ($array_teaching[$index]['Day'] as $key_day => &$value_day) {
                    ...
                    if ($total_hours > $diff_minutes) {
                        if ($i == $len) {
                            ...
                            $error_message = "Insuficient time in faculty no. " . $faculty_id . "</br> NOTE: you need to add teacher time availability 1.";
                    ...
                    $query = "SELECT `user_id` FROM `temporary_sched` WHERE `user_id` = '$user_id' AND `day` = '$available_day' AND faculty_id = '$faculty_id' AND `section` = '$section'";
                    ...
                    if (mysqli_num_rows($query_run) > 0) {
                        ...
                        if ($availability_from_time >= $availability_to_time ||  $availability_to_time < $schedule_to) {
                            ...
                            if ($value_day['teach_no'] >= 8 && $value_day['break_time'] == 1) {
